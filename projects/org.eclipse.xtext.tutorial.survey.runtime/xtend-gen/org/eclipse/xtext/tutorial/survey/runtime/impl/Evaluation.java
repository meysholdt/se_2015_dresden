  ...
  protected CharSequence getHtml(@Extension final DataStore dataStore) {
    ...
    _builder.newLineIfNotEmpty();
    {
      ...
      for(final String key : _sort) {
        ...
        _builder.newLine();
        {
          Set<Map.Entry<String, Integer>> _entrySet = valueCounts.entrySet();
          final Function1<Map.Entry<String, Integer>, Integer> _function = new Function1<Map.Entry<String, Integer>, Integer>() {
            @Override
          ...
          List<Map.Entry<String, Integer>> _sortBy = IterableExtensions.<Map.Entry<String, Integer>, Integer>sortBy(_entrySet, _function);
