...
public class MemberImpl extends MinimalEObjectImpl.Container implements Member
{
  ...
  {
    return ExamplePackage.Literals.MEMBER;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExamplePackage.MEMBER__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ExamplePackage.MEMBER__NAME:
        return getName();
    }
