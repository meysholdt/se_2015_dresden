package org.xtext.example.xbase.serializer;
...
public class ExampleSemanticSequencer extends XbaseSemanticSequencer {

	@Inject
	private ExampleGrammarAccess grammarAccess;
	
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ExamplePackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case ExamplePackage.CLASS:
				if(context == grammarAccess.getClassRule()) {
					sequence_Class(context, (org.xtext.example.xbase.example.Class) semanticObject); 
					return; 
				}
				else break;
			...
			case ExamplePackage.PACKAGE:
				if(context == grammarAccess.getPackageRule()) {
					sequence_Package(context, (org.xtext.example.xbase.example.Package) semanticObject); 
					return; 
				}
				else break;
			}
	 ...
	 */
	protected void sequence_Class(EObject context, org.xtext.example.xbase.example.Class semanticObject) {
	...
	protected void sequence_Field(EObject context, Field semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ExamplePackage.Literals.MEMBER__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExamplePackage.Literals.MEMBER__NAME));
			if(transientValues.isValueTransient(semanticObject, ExamplePackage.Literals.FIELD__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ExamplePackage.Literals.FIELD__TYPE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getFieldAccess().getTypeJvmTypeReferenceParserRuleCall_1_0(), semanticObject.getType());
	 ...
	 */
	protected void sequence_Package(EObject context, org.xtext.example.xbase.example.Package semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
}
