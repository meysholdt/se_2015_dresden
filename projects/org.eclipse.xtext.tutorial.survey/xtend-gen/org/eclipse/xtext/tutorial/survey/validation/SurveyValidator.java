...
public class SurveyValidator extends AbstractSurveyValidator {
  ...
  public void textMustNotBeEmpty(final Question question) {
    ...
    if (_isEmpty) {
      this.error("Empty question is illegal", SurveyPackage.Literals.QUESTION__TEXT);
    }
  }
  ...
  public void textMustNotBeEmpty(final Choice choice) {
    ...
    boolean _isEmpty = _text.isEmpty();
    if (_isEmpty) {
      this.error("Empty choice is illegal", SurveyPackage.Literals.CHOICE__TEXT);
    }
  }
    ...
    for (final Choice choice : _choices) {
      {
        ...
        if (_notEquals) {
          this.error("Duplicate choice text", choice, SurveyPackage.Literals.CHOICE__TEXT);
          this.error("Duplicate choice text", choiceWithSameName, SurveyPackage.Literals.CHOICE__TEXT);
        }
      }
    }
  }
