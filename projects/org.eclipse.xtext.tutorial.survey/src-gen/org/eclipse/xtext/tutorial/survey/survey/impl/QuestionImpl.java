 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.tutorial.survey.survey.impl.QuestionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.xtext.tutorial.survey.survey.impl.QuestionImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QuestionImpl extends MinimalEObjectImpl.Container implements Question
{
  ...
  public void setText(String newText)
  {
    ...
    text = newText;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SurveyPackage.QUESTION__TEXT, oldText, text));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SurveyPackage.QUESTION__NAME:
        return getName();
      case SurveyPackage.QUESTION__TEXT:
        return getText();
    }
